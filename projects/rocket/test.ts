...
const rocket1 = (document.querySelector(".rocket-1") as HTMLElement);
const rocket2 = (document.querySelector(".rocket-2") as HTMLElement);
const rocket3 = (document.querySelector(".rocket-3") as HTMLElement);
// 預先保存原本的位置，方便火箭飛回來回來
