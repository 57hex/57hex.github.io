"use strict";var now=new Date;var end=new Date("2018-10-20T00:00:00");var countDownDay=document.getElementById("count-down-day");var bg_tra1=document.getElementById("bg-tra1");var bg_tra2=document.getElementById("bg-tra2");var bg_tra3=document.getElementById("bg-tra3");var introContent=document.getElementById("intro-inner-content");var isIE=/*@cc_on!@*/false||!!document.documentMode;var height=0;var width=0;var langRemaining=["\u5269\u4E0B","Remaining","\u3042\u3068"];var langDays=["\u5929","Days","\u65E5"];var langHours=["\u5C0F\u6642","hours","\u6642\u9593"];var langMin=["\u5206","min","\u5206"];var langSec=["\u79D2","sec","\u79D2"];var currentLangId=0;var currentLang={"remaining":langRemaining[currentLangId],"days":langDays[currentLangId],"hours":langHours[currentLangId],"min":langMin[currentLangId],"sec":langSec[currentLangId]// function switchLang(x) {
//   currentLangId = x;
//   currentLang = {
